...
public class TemperatureStarter {
    public static void main(String[] args) {
        System.out.println("Добро пожаловать в конвертер. " +
                "Тут ты сможешь переводить температуру из одной системы в другую");
        ...
        System.out.println("Введи пожалуйста систему измерений," +
                " в которую будет переводено указанное ранее значение (возможные варианты - C, K, F):");
